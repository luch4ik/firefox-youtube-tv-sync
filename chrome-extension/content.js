...
(() => {
  ...
  function forceYoutubePlayerVolumeToDefault() {
    const player = getYoutubePlayer();
    if (!player) {
      return;
    }
    ...
    try {
      ...
      state.lastKnownPlayerVolume = 100;
    } catch {
      // Ignore transient YouTube player API failures.
    }
  }
  ...
  function detachRemoteVideo() {
    ...
    forceYoutubePlayerVolumeToDefault();
  }
